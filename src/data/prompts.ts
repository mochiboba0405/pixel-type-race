export const prompts = [
  ...
  'Brave beginners type one clean word at a time and win the race.',
  'A cheerful keyboard can turn practice into a bright little adventure.',
  'Fast fingers are helpful but calm focus makes the finish line easier.',
  'Every typo is just a small signpost pointing toward better rhythm.',
